...
class HotelController extends Controller
{
    ...
    public function actionCetakhotel() {
        ...
        $content =  $this->render('cetakhotel',[
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->ID_HOTEL]);
        } else {
    ...
    public function actionUpdategambar($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if(!$model->GAMBAR==NULL){
                ...
                $model->GAMBAR->saveAs(Url::to('@common/uploads/hotel/') .$namafile.'.'.$extensi);
