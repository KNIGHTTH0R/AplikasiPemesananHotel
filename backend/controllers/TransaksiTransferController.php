...
use backend\models\TransaksiTransferSearch;
...
class TransaksiTransferController extends Controller
{
    ...
    {
        $searchModel = new TransaksiTransferSearch();
    ...
    {
        if (($model = TransaksiTransfer::findOne($id)) !== null) {
            return $model;
        } else {
