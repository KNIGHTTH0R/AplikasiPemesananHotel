...
/**
 * KreditLayananSearch represents the model behind the search form of `common\models\KreditLayanan`.
 */
class KreditLayananSearch extends KreditLayanan
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ID_KREDIT', 'KARTU_NO', 'NOMINAL', 'KETERANGAN'], 'number'],
