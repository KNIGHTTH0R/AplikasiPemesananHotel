...
class PemesananSearch extends Pemesanan
{
    ...
    {
        return [
            [['ID_PEMESANAN', 'NO_IDENTITAS','JUMLAH_HARI', 'KAMAR_ID','JUMLAH_KAMAR'], 'number'],
            [['TANGGAL_MASUK', 'TANGGAL_PESAN','TANGGAL_KELUAR', 'NAMA', 'ALAMAT', 'NO_TELP', 'EMAIL', 'STATUS', 'GAMBAR'], 'safe'],
        ];
    }
    ...
    {
        $query = Pemesanan::find()->joinWith(['kamar'])->where(['STATUS' => 'Paid']);
